...
import { DropDownStepComponentViewConfiguration } from './dropdown-step-component-view-configuration';

export const createDropDownStepComponentViewFactory =
	(isInterrupted: boolean, cfg: DropDownStepComponentViewConfiguration): StepComponentViewFactory =>
